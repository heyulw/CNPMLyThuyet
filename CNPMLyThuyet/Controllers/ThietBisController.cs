...
namespace CNPMLyThuyet.Controllers
{
    public class ThietBisController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaTB,TenTB,NgaySuDung,SoLanBaoTri")] ThietBi thietBi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaTB,TenTB,NgaySuDung,SoLanBaoTri")] ThietBi thietBi)
        {
            if (ModelState.IsValid)
            {
