...
namespace CNPMLyThuyet.Controllers
{
    public class NhanViensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNV,TenNV,SDT,NgaySinh,DiaChi,MaPB,MatKhau")] NhanVien nhanVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNV,TenNV,SDT,NgaySinh,DiaChi,MaPB,MatKhau")] NhanVien nhanVien)
        {
            if (ModelState.IsValid)
            {
